...
public class SourceIndexWriterProjectionSerializationTest {
    ...
    public void testSerialization() throws IOException {
        ...
        assertThat(new SourceIndexWriterProjection(in).isFailFast(), is((!expected.isFailFast())));
        ...
        assertThat(new SourceIndexWriterProjection(in2).isFailFast(), is((expected.isFailFast())));
    }
}
